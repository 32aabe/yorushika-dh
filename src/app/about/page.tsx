  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Before making this project, I thought I already knew Yorushika’s music fairly well. I had listened to the songs many times and understood the hidden story to some extent. However, when I created a map connecting songs and words, I realized that many more words than I expected were repeated across multiple songs. These repeated words helped create the overall atmosphere of Yorushika’s music.",
          "In traditional listening, I usually focus on favorite songs, track order, story, and emotion. However, by connecting songs through words, I could support vague impressions with clearer evidence. Instead of simply feeling that two songs had a similar mood, I could see which words and images created that connection. The digital map made the albums feel less like a fixed sequence of tracks and more like a network that users can explore from different starting points.",
          "This also showed me that digital tools do not replace interpretation. Python could find repeated words, and AI helped with site building and research, but I still had to decide why a word mattered and how it connected to the narrative. AI could not replace that decision, but once my goal became clear, it became a powerful tool for turning the idea into a working project.",
        ],
      },
    ],
  },
  kr: {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "3. The Digital Difference",
        body: [
          "이 프로젝트를 만들기 전에는 요루시카의 음악을 어느 정도 잘 알고 있다고 생각했다. 노래를 많이 들었고, 두 앨범에 숨겨진 스토리도 어느 정도 이해하고 있다고 느꼈다. 그러나 직접 곡과 단어를 연결하는 맵을 만들어보니, 생각보다 많은 단어들이 여러 곡에서 반복되고 있다는 것을 알게 되었다. 그리고 이러한 반복 단어들이 요루시카 특유의 분위기를 만들어낸다는 점도 더 분명하게 느낄 수 있었다.",
          "전통적인 방식으로 앨범을 들을 때는 보통 좋아하는 곡이나 트랙 순서, 감정과 서사 흐름에 집중하게 된다. 하지만 단어를 기준으로 곡들을 연결하자, 막연히 비슷하다고 느꼈던 곡들을 더 구체적인 근거를 가지고 연결할 수 있었다. 단순히 두 곡의 분위기가 비슷하다고 느끼는 것에서 나아가, 어떤 단어와 이미지가 그 연결감을 만드는지 확인할 수 있었기 때문이다.",
          "이 점에서 디지털 분석은 내가 이미 알고 있다고 생각했던 작품을 다시 보게 만드는 도구가 되었다. 앨범은 더 이상 정해진 트랙 순서로만 경험되는 것이 아니라, 사용자가 한 곡에서 출발해 공유되는 단어를 따라 다른 곡으로 이동할 수 있는 관계망처럼 보였다.",
          "동시에 이 프로젝트는 디지털 도구가 해석을 대신해주지는 않는다는 점도 보여주었다. Python은 반복되는 단어를 찾아주고, AI는 사이트 제작과 자료 탐색을 도와줄 수 있었지만, 왜 어떤 단어가 중요한지, 그 단어가 서사와 어떻게 연결되는지는 결국 내가 직접 판단해야 했다. AI는 그 판단을 대신할 수는 없지만, 내가 보여주고자 하는 방향이 분명할 때 그 아이디어를 실제 결과물로 만드는 강력한 도구가 될 수 있었다.",
        ],
      },
    ],
  },
  jp: {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "3. The Digital Difference",
        body: [
          "このプロジェクトを作る前、私はヨルシカの音楽をある程度よく知っていると思っていた。曲を何度も聴いており、二つのアルバムに隠された物語もある程度理解していると感じていた。しかし実際に曲と言葉をつなぐマップを作ってみると、想像していた以上に多くの単語が複数の曲で繰り返されていることに気づいた。そして、その繰り返される言葉がヨルシカ特有の雰囲気を作り出していることも、よりはっきりと感じられた。",
          "従来の聴き方では、好きな曲、トラック順、感情や物語の流れに注目することが多い。しかし単語を基準に曲をつなげてみると、なんとなく似ていると感じていた曲同士を、より具体的な根拠をもって結びつけることができた。単に二つの曲の雰囲気が似ていると感じるだけでなく、どの言葉やイメージがそのつながりを作っているのかを確認できたからである。",
          "この点で、デジタル分析は、自分がすでに知っていると思っていた作品を改めて見直すための道具になった。アルバムはもはや決められたトラック順でのみ経験されるものではなく、ユーザーが一つの曲から出発し、共有される言葉をたどって別の曲へ移動できる関係のネットワークとして見えるようになった。",
          "同時に、このプロジェクトはデジタルツールが解釈そのものを代わりに行うわけではないことも示してくれた。Pythonは繰り返される単語を見つけ、AIはサイト制作や資料探しを助けてくれたが、なぜある単語が重要なのか、その単語が物語とどのようにつながるのかは、最終的に自分で判断する必要があった。AIはその判断を代替することはできないが、自分が見せたい方向が明確であれば、そのアイデアを実際の形にする強力な道具になり得ると感じた。",
        ],
      },
    ],
  },
